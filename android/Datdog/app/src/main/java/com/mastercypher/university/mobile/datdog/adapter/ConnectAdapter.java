...
public class ConnectAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (dog.getId().equals("none")) {
            ...
            TextView txvBirth = (TextView) convertView.findViewById(R.id.txv_num_items);
            txvName.setText(dogSection);
            txvBirth.setText(String.valueOf(dogNumItems));
            return convertView;
        } else {
            if (convertView == null) {
                convertView = LayoutInflater.from(mContext).inflate(R.layout.adapter_dogs, parent, false);
            }
